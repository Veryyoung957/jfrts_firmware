...
void chassis_task(void const *argument)
{
    ...
    pid_struct_init(&pid_follow, MAX_CHASSIS_VW_SPEED, 50, 80.0f, 0.0f, 10.0f);//wq
...
//						chassis_set_speed(&chassis, 0, 0, 100);
...
int32_t chassis_angle_broadcast(void *argv)
{
    ...
    can2_std_transmit(0x401, data, 8);
    return 0;
}
...
void local_follow_relative()
{
    gimbal_t p_gimbal;
		p_gimbal = get_gimbal();
		follow_relative_angle = p_gimbal->ecd_angle.yaw / 10.0f;
}
