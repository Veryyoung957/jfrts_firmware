...
struct offline_obj chassis_offline_table[] =
{
    ...
    {OFFLINE_MANIFOLD2_HEART, ENABLE, OFFLINE_WARNING_LEVEL, BEEP_DISABLE, 700, NULL, chassis_heart_offline, NULL, chassis_heart_online},
    ...
    {OFFLINE_GIMBAL_INFO, DISABLE, APP_PROTECT_LEVEL, 0, 700, NULL, gimbal_info_offline, NULL, gimbal_info_online},
};

struct route_obj chassis_route_table[] =
{
    {GIMBAL_ADDRESS, "can2_0x500_to_0x600"},
...
void chassis_app_init(void)
{
    ...
    protocol_can_interface_register("can2_0x500_to_0x600", 1024, 1, CAN2_PORT, GIMBAL_CAN_ID, CHASSIS_CAN_ID, can2_std_transmit);
...
/**
  * @brief  chassis can1 receive interupt
  * @param
  * @retval void
  */
